...
export const Header: FC = () => {
    ...
    const quantities = items.reduce((acc, item) => acc + item.quantity, 0);
                                    ...
                                    >
                                        <div className={"flex items-center"}>
                                            ...
                                            >
                                                ...
                                                {quantities > 0 && (
                                                    <div className="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-1 right-5 dark:border-gray-900">
                                                        {quantities}
                                                    </div>
                                                )}
                                            </button>
                                            <Menu.Button className="cursor-pointer flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                                {user?.avatarUrl ? (
                                                    ...
                                                    <label className="cursor-pointer relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
