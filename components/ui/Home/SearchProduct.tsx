...
export const SearchProduct: FC<ISearchProduct> = ({
    search,
    handleSort,
    handleSearch
}) => {
    const [dropdown, setDropdown] = useState<boolean>(false);
    const [sortName, setSortName] = useState<string | ReactElement>(
        "Сортировать"
    );
        ...
        <div className="flex m-2 mt-0">
            ...
            <div
                ...
                className={classNames(
                    ...
                    "z-20 w-32 p-3 bg-white rounded-lg shadow dark:bg-gray-700 mt-12"
                )}
            >
                <ul
