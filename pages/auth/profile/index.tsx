            ...
            {!isLoading ? (
                <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16 relative">
                    ...
                    <div className={"flex items-center justify-center"}>
                        {user?.avatarUrl ? (
                            <label className="relative inline-flex items-center justify-center w-36 h-36 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600 hover:bg-gray-300 transition-all">
                                <Image
                                    loader={() =>
                            ...
                            <label className="relative inline-flex items-center justify-center w-36 h-36 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
