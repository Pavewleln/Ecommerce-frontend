                ...
                ? <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16 relative">
                    ...
                    <dl className="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                        <div className="flex flex-col pb-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Фамилия</dt>
                            <dd className="text-lg font-semibold">{user?.surname}</dd>
                        </div>
                        <div className="flex flex-col pb-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Электронная почта</dt>
                            <dd className="text-lg font-semibold">{user?.email}</dd>
                        </div>
                        <div className="flex flex-col pt-3">
                            <dt className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Номер телефона</dt>
